...
func newTestMuxWithLimits(maxWidth, maxHeight int) *chi.Mux {
	...
	mux.Post("/unsafe/{operation}/{width}x{height}/filters:no_upscale()/filters:format({format})/", h)
	mux.Post("/unsafe/{operation}/{width}x{height}/filters:no_upscale()/filters:format({format})", h)
	mux.Post("/unsafe/{width}x{height}/filters:format({format})/", h)
	mux.Post("/unsafe/{width}x{height}/filters:format({format})", h)
	return mux
}
...
func TestPushEndpoint_FitIn_JPEG(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/100x100/filters:no_upscale()/filters:format(jpeg)/", body)
...
func TestPushEndpoint_FitIn_PNG(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/100x100/filters:no_upscale()/filters:format(png)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
...
func TestPushEndpoint_FitIn_GIF(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/100x100/filters:no_upscale()/filters:format(gif)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
...
func TestPushEndpoint_FitIn_GIFPreservesAnimation(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/50x50/filters:no_upscale()/filters:format(gif)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
	...
	// fit-in with no_upscale must not enlarge the 200x100 source to 50x50.
...
func TestPushEndpoint_FitIn_NoUpscale(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/200x200/filters:no_upscale()/filters:format(png)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
	...
	if bounds.Dx() > 50 || bounds.Dy() > 50 {
		t.Errorf("no_upscale should not enlarge the image, got %dx%d", bounds.Dx(), bounds.Dy())
	}
}
...
func TestPushEndpoint_BadDimensions(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/abcxdef/filters:no_upscale()/filters:format(jpeg)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
...
func TestPushEndpoint_ZeroDimensions(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/0x0/filters:no_upscale()/filters:format(jpeg)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
...
func TestPushEndpoint_UnsupportedFormat(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/50x50/filters:no_upscale()/filters:format(webp)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
...
func TestPushEndpoint_InvalidImageData(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/50x50/filters:no_upscale()/filters:format(jpeg)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
...
func TestPushEndpoint_NotMultipart(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/fit-in/50x50/filters:no_upscale()/filters:format(jpeg)/", bytes.NewReader([]byte("plain text")))
	rec := httptest.NewRecorder()
...
func TestPushEndpoint_Stretch(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/unsafe/stretch/64x32/filters:no_upscale()/filters:format(png)/", body)
	req.Header.Set("Content-Type", contentType)
	rec := httptest.NewRecorder()
