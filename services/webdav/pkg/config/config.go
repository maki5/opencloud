...
type Config struct {
	...
	ThumbnailCacheBackend     string   `yaml:"thumbnail_cache_backend" env:"WEBDAV_THUMBNAIL_CACHE_BACKEND" desc:"Cache backend for imagor thumbnails: 'memory', 'file', or 's3'. Default: file." introductionVersion:"1.0.0"`
