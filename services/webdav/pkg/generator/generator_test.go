...
func TestBuildURL(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			operation: OpFill,
			ext:       "jpeg",
			want:      "http://generator/unsafe/128x128/filters:no_upscale()/filters:format(jpeg)/",
		},
		{
			...
			operation: OpFitIn,
			ext:       "jpeg",
			want:      "http://generator/unsafe/fit-in/1024x1024/filters:no_upscale()/filters:format(jpeg)/",
		},
		{
			...
			operation: OpStretch,
			ext:       "png",
			want:      "http://generator/unsafe/stretch/64x32/filters:no_upscale()/filters:format(png)/",
		},
	}
